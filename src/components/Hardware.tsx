    ...
    <section className="py-32 relative bg-[#040404] overflow-hidden">
      ...
      <div className="container relative z-10 max-w-5xl mx-auto">
        <div className="text-center mb-20 relative">
          ...
          <h2 className="font-display text-4xl md:text-5xl lg:text-7xl font-black text-white leading-[0.9] uppercase tracking-tighter mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 pt-4">
          <div className="p-10 rounded-none bg-[#0D0D0D]/90 backdrop-blur-md border border-white/5 hover:border-primary/30 transition-all duration-500 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-display font-black text-white mb-4 uppercase tracking-wider">Conectividade Crítica</h3>
          ...
          <div className="p-10 rounded-none bg-[#0D0D0D]/90 backdrop-blur-md border border-white/5 hover:border-primary/30 transition-all duration-500 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-display font-black text-white mb-4 uppercase tracking-wider">Interceptação Remota</h3>
            <p className="text-white/70 leading-relaxed font-light text-sm group-hover:text-white transition-colors">
          ...
          <div className="p-10 rounded-none bg-[#0D0D0D]/90 backdrop-blur-md border border-white/5 hover:border-primary/30 transition-all duration-500 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-display font-black text-white mb-4 uppercase tracking-wider">Geolocalização Ativa</h3>
            <p className="text-white/70 leading-relaxed font-light text-sm group-hover:text-white transition-colors">
          ...
          <div className="p-10 rounded-none bg-[#0D0D0D]/90 backdrop-blur-md border border-white/5 hover:border-primary/30 transition-all duration-500 group relative overflow-hidden">
            ...
            <h3 className="text-2xl font-display font-black text-white mb-4 uppercase tracking-wider">Protocolo Anti-Sabotagem</h3>
            <p className="text-white/70 leading-relaxed font-light text-sm group-hover:text-white transition-colors">

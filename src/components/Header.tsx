  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "border-b border-border/50 bg-background/95 shadow-lg shadow-black/30 backdrop-blur-xl"
    ...
    >
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Button
            size="sm"
            className="font-display font-semibold shadow-[0_0_20px_hsl(var(--primary)/0.3)] hover:shadow-[0_0_30px_hsl(var(--primary)/0.5)] transition-shadow"
          >
            Área do Cliente
          </Button>
        </nav>
        ...
        <button
          className="md:hidden text-foreground p-1 rounded-md hover:bg-secondary/50 transition-colors"
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-border bg-background/98 backdrop-blur-xl">
          <nav className="container flex flex-col gap-2 py-6">
            ...
            <Button className="font-display font-semibold w-full mt-3">
              Área do Cliente
            </Button>
          </nav>
        </div>
